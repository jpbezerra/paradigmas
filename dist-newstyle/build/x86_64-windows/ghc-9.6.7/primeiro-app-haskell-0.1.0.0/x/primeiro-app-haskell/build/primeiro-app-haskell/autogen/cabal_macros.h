...
/* package primeiro-app-haskell-0.1.0.0 */
#ifndef VERSION_primeiro_app_haskell
#define VERSION_primeiro_app_haskell "0.1.0.0"
#endif /* VERSION_primeiro_app_haskell */
#ifndef MIN_VERSION_primeiro_app_haskell
#define MIN_VERSION_primeiro_app_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_primeiro_app_haskell */
...
#define CURRENT_COMPONENT_ID "primeiro-app-haskell-0.1.0.0-inplace-primeiro-app-haskell"
